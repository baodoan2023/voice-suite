...
_REQUIRED_KEYS = ("exe", "sherpa_model_dir", "mt_dir", "tts_venv",
                  "tts_server_script", "tts_ref_wav")

_TEMPLATE = """\
# impls/m2v_sherpa/local.toml — machine-local paths (git-ignored)
exe = "C:/project/training_ai/my-2nd-voice/target/release/eval-batch.exe"
sherpa_model_dir = "C:/project/training_ai/my-2nd-voice/models/asr/sherpa-vi"
...
class M2vSherpaImpl:
    ...
    def __init__(self, name: str = "m2v_sherpa",
    ...
    def setup(self) -> None:
        ...
        self._cmd = [
            str(cfg["exe"]),
            "--sherpa-model-dir", str(cfg["sherpa_model_dir"]),
